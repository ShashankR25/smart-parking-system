...
void loop()
{
    ...
    Firebase.setInt(fbda, "SlotBooking/slot1", slot1);
    Firebase.setInt(fbda, "SlotBooking/slot2", slot2);
    Firebase.setInt(fbda, "SlotBooking/slot3", slot3);
    Firebase.setInt(fbda, "SlotBooking/slot4", slot4);
}
